      ...
      <InnerWrapper>
        ...
        <div className='grid grid-cols-1 gap-4 xl:w-1/2'>
          ...
          <QuestionCard
            ...
            answer='The ceremony will take place outside and the reception will follow afterwards indoors'
          />
          <QuestionCard
            question='Parking?'
            ...
            children={
              <div className='p-4 mt-4 rounded-md bg-cream-light'>
                ...
                <div className='flex flex-col gap-2 md:w-1/2'>
                  <div className='flex items-center justify-center gap-2 px-2 bg-black border rounded-md'>
          ...
          <QuestionCard
            ...
            children={
              <div className='flex items-center gap-2 px-2 border rounded-md w-44 bg-cream-light'>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-8 h-8 text-black">
